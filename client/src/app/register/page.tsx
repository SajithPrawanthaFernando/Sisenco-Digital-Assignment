  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex relative items-center justify-center p-4 py-12 pb-20 w-full">
        <div className="absolute top-[10%] right-[20%] w-[500px] h-[500px] bg-purple-600/30 rounded-full blur-[120px] -z-10 pointer-events-none" />
        <div className="absolute bottom-[10%] left-[20%] w-[500px] h-[500px] bg-blue-600/30 rounded-full blur-[120px] -z-10 pointer-events-none" />
          ...
          >
            ...
            <div className="text-center mb-8 anim-item">
              ...
              <p className="text-zinc-400 text-sm">
                Start tracking your expenses and goals today.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white py-3.5 rounded-xl font-bold transition-all active:scale-[0.98] shadow-[0_0_20px_rgba(147,51,234,0.3)] hover:shadow-[0_0_30px_rgba(147,51,234,0.5)] disabled:opacity-70 disabled:pointer-events-none mt-4 border border-purple-400/20"
              >
                {isLoading ? (
                  <>
            ...
            <p className="anim-item text-center text-sm text-zinc-500 mt-8">
              ...
              <Link
                href="/login"
                className="text-white font-medium hover:text-purple-400 transition-colors underline underline-offset-4"
              >
                Sign in here
              </Link>
            </p>
